  ...
  set(name, save = true) {
    ...
    const resolvedTheme =
      resolvedName === "system"
        ...
        : resolvedName === "reverse-system"
          ? theme.getReverseSystemTheme()
          : resolvedName;
    ...
    document.getElementById(
      "judge0-golden-layout-dark-theme-stylesheet"
    ).disabled = isLight;
    document.getElementById(
      "judge0-golden-layout-light-theme-stylesheet"
    ).disabled = !isLight;

    monaco.editor.setTheme(isLight ? "vs-light" : "vs-dark");

    [".ui.menu", ".ui.input"].forEach((s) =>
    ...
    document
      .getElementById("judge0-theme-toggle-btn")
      .setAttribute(
        "data-content",
        `Switch between dark, light, and system theme (currently ${resolvedName} theme)`
      );
    const themeToggleBtnIcon = document.getElementById(
      "judge0-theme-toggle-btn-icon"
    );
